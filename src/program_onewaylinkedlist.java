 ...
 * @author lenovo
 */
public class program_onewaylinkedlist extends javax.swing.JFrame {
...
public class LinkedList{
    public void insert(String studentid,String name,String surname,String email){
        ...
        //insert jtable
        //String student[]={NEW.studentid,NEW.name,NEW.surname,NEW.email};
    ...
    if(index==0){
       insertAtStart(studentid,name,surname,email);}
    else{
	Node PTR = START;
    ...
    private void initComponents() {
        ...
        jLabel9.setText("SINGLY_LINKEDLIST");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        //search 
       Node Result = SEARCH(jTextField7.getText());
       if (Result !=null)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new program_onewaylinkedlist().setVisible(true);
            }
        });
    }
