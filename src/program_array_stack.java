 ...
 * @author lenovo
 */
public class program_array_stack extends javax.swing.JFrame {
    ...
    public program_array_stack() {
        initComponents();
        jTable1.setAutoCreateRowSorter(true); //sort table
    }
    
    public void InsertLOC(int ITEM_ID, String ITEM_NAME, String ITEM_SURNAME, String ITEM_EMAIL, int K) {
    //insert loc
        int J = N;
        while (J >= K) {
            id[J + 1] = id[J];
        ...
        id[K] = ITEM_ID;
        name[K] = ITEM_NAME;
        surname[K] = ITEM_SURNAME;
        email[K] = ITEM_EMAIL;
        N++;
        showdata();
    }

    public void Insert(int ITEM_ID, String ITEM_NAME, String ITEM_SURNAME, String ITEM_EMAIL) {
        int i = N;
        id[i] = ITEM_ID;
        name[i] = ITEM_NAME;
        surname[i] = ITEM_SURNAME;
        email[i] = ITEM_EMAIL;   
        showdata();
        i++;
        N++;
    ...
    public void showdata() {
        ...
        for (int i = 0; i <= N-1; i++) {
            ...
            model.setValueAt(id[i], i, 0);
            model.setValueAt(name[i], i, 1);
            model.setValueAt(surname[i], i, 2);
            model.setValueAt(email[i], i, 3);
            }
        }
        ...
        for (int K = 0; K < N - 1; K++) {   
            ...
            while (PTR < ((N - 1) - K)) {   
                if (id[PTR] > id[PTR + 1]) {
                    ...
                    String temp1 = name[PTR];  
                    name[PTR] = name[PTR + 1];
                    name[PTR + 1] = temp1;
                    
                    String temp2 = surname[PTR];  
                    surname[PTR] = surname[PTR + 1];
                    surname[PTR + 1] = temp2;
                    
                    String temp3 = email[PTR];  
                    email[PTR] = email[PTR + 1];
                    email[PTR + 1] = temp3;
                }
                PTR++;
            }
    ...
    private void initComponents() {
        ...
        jButton11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_Descending_Sorting_32px.png"))); // NOI18N
        jButton11.setText("BUBBLESORT");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jTextField1.setText(String.valueOf(id[index]));
        jTextField2.setText(name[index]);
        jTextField3.setText(surname[index]);
        jTextField4.setText(email[index]);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // insert
        Insert(Integer.parseInt(jTextField1.getText()), jTextField2.getText(), jTextField3.getText(), jTextField4.getText());
        showdata();
        jTextField1.setText("");
        jTextField2.setText("");
        jTextField3.setText("");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        InsertLOC(Integer.parseInt(jTextField1.getText()), jTextField2.getText(), jTextField3.getText(), jTextField4.getText(), K);
        jTextField1.setText("");
        jTextField2.setText("");
        jTextField3.setText("");
        jTextField4.setText("");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        //search   
        int ITEM = Integer.parseInt(jTextField7.getText());
        id[N] = ITEM;
        int LOC = 0;
        while (id[LOC]!=ITEM) {
            LOC++;
        ...
        if (LOC == N) {
            ...
            JOptionPane.showMessageDialog(null, "Found Result: "+ITEM+"\n"+"At Index: "+LOC);
        }
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        //push
       if(TOP<MAXSTK){
       id[TOP] = Integer.parseInt(jTextField1.getText());
       name[TOP] = jTextField2.getText();
       surname[TOP] = jTextField3.getText();
       email[TOP] = jTextField4.getText();
       TOP++;
       }
       else {
           JOptionPane.showMessageDialog(null, "OVERFLOW!", "info", JOptionPane.ERROR_MESSAGE);}       
       N++;
       showdatastack();    
       jTextField1.setText("");
       jTextField2.setText("");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        //pop
       if(TOP<1){
       JOptionPane.showMessageDialog(null, "UNDERFLOW!", "info", JOptionPane.ERROR_MESSAGE);    
       }else{
           id[TOP]=id[TOP+1];
           name[TOP]=name[TOP+1];
           surname[TOP]=surname[TOP+1];
           email[TOP]=email[TOP+1];       
       }
       TOP--;
       N--;
       showdatastack(); 
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new program_array_stack().setVisible(true);
            }
        });
    }
